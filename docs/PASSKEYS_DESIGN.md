...
| 步骤 | 平台    | 内容                                                                                                                                                                                                                                 | 验收                                                                        |
| ---- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| P4.1 | 共通    | ✅ 已落地（2026-09-24，协议 v3）：`passkey_credential_provider_list/assert` 消息族（`docs/BRIDGE_PROTOCOL.md` §12/§13），沿用 HMAC 配对与 user gesture 闸门；core 侧 origin↔rp_id 校验不变                                             | 协议用例（cli bridge 46 测试）+ 桌面审批白名单用例走通                       |
